...
Was the API on 3001 or 8080? With portless, it is always `http://api.localhost`.
...
AI coding agents guess or hardcode the wrong port, especially in monorepos. A stable URL like `http://myapp.localhost` is deterministic and reliable.
